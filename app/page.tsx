          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Instagram API 연동으로 팔로워, 인게이지먼트 등 실시간 데이터 확인
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  필터링과 정렬 기능으로 원하는 조건의 파트너를 빠르게 찾을 수 있습니다
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-gray-50 border-t">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="font-bold text-lg text-green-600">itda</div>
            <p className="text-sm text-gray-600">© 2024 itda. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
